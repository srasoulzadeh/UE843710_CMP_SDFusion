...
class TargetAugmentedDataset(BaseDataset):
    ...
    def initialize(self, opt, phase='train', cat='all', res=64):
        ...
        file_list = f'{dataroot}/TARGETAUGMENTED/splits/{phase}_split.txt'

        SDF_dir = f'{dataroot}/TARGETAUGMENTED/SDF/resolution_{res}'
    ...
    def name(self):
        return f'TargetAugmented-{self.res}'